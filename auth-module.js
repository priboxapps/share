...
// In AuthModule class, add these methods:
...
getMasterDB() {
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <label class="form-label" for="signup-phone">
                                    Phone Number <span class="required-modern">*</span>
                                </label>
                                <input type="tel" id="signup-phone" class="form-input" 
                                    placeholder="123 456-7890">
                                <div class="form-help-modern">11 digits required</div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="password-input-group">
                                    ...
                                    <button type="button" class="toggle-pass-modern" data-target="signup-password">
                                        <span class="material-icons">visibility_off</span>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="password-input-group">
                                    ...
                                    <button type="button" class="toggle-pass-modern" data-target="signup-confirm">
                                        <span class="material-icons">visibility_off</span>
                                    </button>
                                </div>
                            </div>
    ...
    displayRecoveryCodes(codes) {
        // Directly open print window with recovery codes
        this.printRecoveryCodes(codes);
        
        // Also download as backup
        setTimeout(() => {
            this.downloadRecoveryCodes(codes);
        }, 500);
    }
    ...
    printRecoveryCodes(codes) {
        ...
        printWindow.document.write(`
            <html>
            <head>
                <title>PriBox Recovery Codes</title>
                <style>
                    body { 
            ...
            <body>
                <h1>🔐 PriBox Recovery Codes</h1>
                <div class="date">Generated on: ${new Date().toLocaleString()}</div>
                
                <div class="warning">
                    <h3>⚠️ IMPORTANT - SAVE THESE CODES</h3>
                    <p>Store this document securely. These codes are required for password recovery.</p>
                    <p>If you lose these codes, you may lose access to your account.</p>
                </div>
                ...
                <div class="codes">
                    ${codes.map((codeObj, index) => `
                        <div class="code-item">
                            ...
                            <span class="code-value">${codeObj.code}</span>
                        </div>
                    `).join('')}
                </div>
                
                <div class="instructions">
                    <h3>📋 How to use recovery codes:</h3>
                    <ul>
                        <li>Each code can be used only once</li>
                        <li>You will need one code to reset your password</li>
                        <li>Store these codes securely (password manager, safe, encrypted file)</li>
                        <li>Generate new codes from your account settings if you lose these</li>
                        <li>Never share your recovery codes with anyone</li>
                    </ul>
                </div>
                
                <div class="no-print" style="text-align: center; margin-top: 30px; padding: 20px; background: #e8f4fd; border-radius: 8px;">
                    <p style="margin: 0; color: #0284c7;">✓ A backup file has been downloaded automatically</p>
                    <p style="margin: 5px 0 0 0; font-size: 14px; color: #666;">Save both the printed copy and the downloaded file in secure locations.</p>
                </div>
    ...
    downloadRecoveryCodes(codes) {
        const content = `🔐 PriBox Recovery Codes
        ...
        a.href = url;
        a.download = `pribox-recovery-codes-${new Date().toISOString().split('T')[0]}.txt`;
    ...
    async handleSignup() {
        ...
        if (!this.validatePhoneNumber(phone)) {
            this.showAuthError('signup-error', 'Please enter a valid phone number (11 digits)');
            return;
        }
        ...
        try {
            ...
            this.showAuthSuccess('signup-success', 'Account created successfully! Generating recovery codes...');
            this.setButtonLoading('signup-btn', false);
            
            // Show recovery codes via print window and download after a delay
            setTimeout(() => {
    ...
    async handleLostRecoveryCodes() {
        ...
        this.showAuthError('recovery-code-error', 
            'If you have lost all recovery codes, please contact support at support@pribox.example.com ' +
