        ...
        return [
            {
                ...
                photos: [], // Changed from ['default_1'] to empty array
                isSystemAlbum: true
            },
            {
                id: 'favorites',
    ...
    if (modal && message) {
        ...
        if (photosInAlbums.length > 0) {
            warningText = `<div style="margin-top: 8px; font-size: 0.7rem; opacity: 0.8;">
                <i class="fas fa-info-circle"></i> ${photosInAlbums.length} of these photos are in custom albums and will be removed from them.
            </div>`;
        }
    ...
    async performDelete() {
        ...
        if (type === 'batch') {
            ...
            if (this.currentFilter === id) {
                ...
                if (createAlbumBtn) createAlbumBtn.style.display = 'block';
...
getPhotosHTML() {
    return `
        <div class="photos-container">
                ...
                <div class="album-management-content">
                    ...
                    <div class="album-management-body">
                        <div class="form-group">
                            <label class="form-label" for="albumName">Album Name (max 12 characters, no spaces)</label>
                            <input type="text" 
                                id="albumName" 
                                class="form-input" 
                    ...
                    <div class="album-delete-confirmation-panel" id="albumDeleteConfirm" style="display: none;">
                        <div class="album-delete-content-panel">
                            <p class="album-delete-warning-panel">
                                <i class="fas fa-info-circle"></i> 
                                This will not delete the photos inside the album, but they will be moved to your main library.
                            </p>
                            <div class="album-delete-actions-panel">
                                <button class="btn btn-danger confirm-album-delete-btn" id="confirmAlbumDeleteBtn">
                                    <i class="fas fa-trash"></i> Delete Album
                                </button>
                                <button class="btn btn-secondary" id="cancelAlbumDeleteBtn">
                                    Cancel
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="album-management-actions">
                        ...
                        <button class="btn btn-primary" id="saveAlbumBtn"><i class="fas fa-plus"></i>Create Album</button>
            ...
            <div class="albums-section">
                <div class="photo-section-header">
                    ...
                    <div class="album-actions">
                        <button class="btn btn-primary" id="createAlbumBtn" style="display: block;">
            ...
            <div class="batch-delete-panel" id="confirmBatchDelete" style="display: none;">
                <div class="batch-confirmation-content">
                    ...
                    <div class="batch-confirmation-actions">
                        <button class="btn btn-danger" id="confirmBatchDeleteBtn">
                            <i class="fas fa-trash"></i> Delete
                        </button>
                        <button class="btn btn-secondary" id="cancelBatchDeleteBtn">
                            Cancel
                        </button>
                    </div>
                </div>
                    ...
                    <div class="photo-delete-panel" id="photoDeletePanel" style="display: none;">
                        <div class="photo-confirmation-content-panel">
                            ...
                            <div class="photo-confirmation-actions-panel">
                                <button type="button" class="btn btn-warning" id="confirmPhotoDeleteBtn"><i class="fas fa-trash"></i> Delete</button>
            ...
            <div class="empty-state" id="emptyState" style="display: none;">
                ...
                <button class="btn" id="uploadFirstPhotosBtn">
    ...
    attachEventListeners() {
        ...
        // Album buttons
        document.getElementById('createAlbumBtn')?.addEventListener('click', () => this.openAlbumModal());
    ...
    applyFilter(albumId) {
        ...
        if (manageAlbumBtn) {
            const album = this.albums.find(a => a.id.toString() === albumId.toString());
            createAlbumBtn.style.display = album && !album.isSystemAlbum ? 'none' : 'block';
...
openAlbumModal(albumId = null) {
    ...
    if (albumModal) {
        ...
        if (saveAlbumBtn) {
            saveAlbumBtn.textContent = isEditing ? 'Update Album' : 'Create Album';
        }
